    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
        ...
        <button
          ...
          className="self-start sm:self-auto text-white px-4 py-2 text-sm sm:px-5 sm:py-2.5 sm:text-base rounded-xl font-medium flex items-center space-x-2 transition-all hover:shadow-lg"
          style={{
