...
const TABS: { id: TabId; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828L13 14.586" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3l7 4v5c0 4.418-3.134 8.166-7 9-3.866-.834-7-4.582-7-9V7l7-4z" />
      </svg>
    ),
  },
];
...
export default function SettingsPage() {
  ...
  // (and whenever the saved name changes).
  useEffect(() => {
    if (user) {
      ...
      {activeTab === 'profile' && (
        <form onSubmit={handleProfileSubmit} className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Update your personal information and preferences.</p>
          </div>
          ...
          <div className="flex justify-end mt-6">
            <button
              ...
              className={`px-5 py-2.5 rounded-xl font-medium transition-all ${
                isProfileDirty && !isLoading
                  ? 'text-white hover:shadow-lg cursor-pointer'
                  : 'text-gray-500 bg-gray-200 cursor-not-allowed'
              }`}
              style={
                isProfileDirty && !isLoading
                  ? { backgroundColor: '#6366f1', boxShadow: '0 2px 8px rgba(99, 102, 241, 0.2)' }
                  : undefined
              }
            >
      ...
      {activeTab === 'appearance' && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Customize how the app looks and feels.</p>
          </div>
          <div className="flex items-center justify-between">
            <div>
      ...
      {activeTab === 'billing' && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Manage your plan and payment methods.</p>
          </div>
      ...
      {activeTab === 'security' && (
        ...
        <form onSubmit={handlePasswordSubmit} className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Update the password you use to sign in.</p>
          </div>
        ...
        <div className="bg-white rounded-xl border border-red-200 p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Manage your data and account.</p>
          </div>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
