...
//
// The beta header below is separate from the release list — it's a standing
// banner shown above the entries while we're in beta (not a dated release).
...
// Standing beta header, rendered above the release list (always shown, not
// version-tracked). Remove this once we're out of beta.
export const WHATS_NEW_BETA_HEADER = {
  title: 'Welcome to the Trend web app beta',
  subtitle: 'Thanks for helping us test — here’s what’s new.',
};
