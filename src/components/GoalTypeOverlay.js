...
const GoalTypeOverlay = ({visible, onClose, onTypeSelect}) => {
      ...
      <Animated.View
        ...
        <View style={styles.header}>
          ...
          <View style={styles.titleContainer}>
            ...
            <Text style={styles.subtitle}>What type of goal?</Text>
          </View>
        </View>
        ...
        <View style={styles.typeOptions}>
          <TouchableOpacity
            ...
            onPress={() => onTypeSelect('savings')}
            activeOpacity={0.7}>
            <View style={[styles.typeIconContainer, styles.savingsIcon]}>
              <Icon name="cash-outline" size={24} color="#007AFF" />
            </View>
            <View style={styles.typeContent}>
              <Text style={styles.typeTitle}>Savings</Text>
          ...
          <TouchableOpacity
            style={styles.typeButton}
            onPress={() => onTypeSelect('spending')}
            activeOpacity={0.7}>
            <View style={[styles.typeIconContainer, styles.spendingIcon]}>
              <Icon name="card-outline" size={24} color="#F59E0B" />
            </View>
            <View style={styles.typeContent}>
              <Text style={styles.typeTitle}>Spending Budget</Text>
              <Text style={styles.typeDescription}>
